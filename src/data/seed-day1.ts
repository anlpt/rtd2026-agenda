...
// Transcribed from " Master Plan - RTD 2026 - AGENDA-10.07.csv".
...
export const day1Sessions: Session[] = [
  s({ day_id: DAY1, type: 'break', code: null, title: 'Greetings & Registration', speaker: null, chair: null, panelists: null, room: 'Lobby B1', start_time: '07:30', end_time: '08:00', description: null, papers: null }),
  s({ day_id: DAY1, type: 'showcase', code: null, title: 'FutureScape Showcase — Partner Exhibition Booths', speaker: null, chair: null, panelists: null, room: 'Lobby B1', start_time: '07:30', end_time: '16:30', description: 'All-day showcase of technology solutions, applied research, digital mapping, sustainability initiatives, immersive media and creative design. Exhibition booths and innovation showcases by HPT, UOB, WATA Software, Leonix Vietnam, Cloudmap, Wuxi University, UEH Sustainability, Hologram Walk, and an Art Exhibition.', papers: null }),
  ...
  s({ day_id: DAY1, type: 'ceremony', code: null, title: 'Welcome Address & Opening Ceremony', speaker: null, chair: null, panelists: null, room: 'Hall B1.302', start_time: '08:00', end_time: '08:45', description: '08:00 Opening Remarks (Assoc. Prof. Bui Quang Hung) · 08:10 UEH Development Strategy (Assoc. Prof. Bui Quang Hung) · 08:25 Journal of Technology and Design Introduction (Assoc. Prof. Trinh Thuy Anh / Prof. Nguyen Truong Thinh) · 08:40 Gift & Photo Session.', papers: null }),
  s({ day_id: DAY1, type: 'break', code: null, title: 'Short Break', speaker: null, chair: null, panelists: null, room: null, start_time: '08:45', end_time: '09:00', description: null, papers: null }),
  ...
  s({ day_id: DAY1, type: 'break', code: null, title: 'Lunch', speaker: null, chair: null, panelists: null, room: 'Hall B1.12A', start_time: '11:15', end_time: '12:15', description: null, papers: null }),
  ...
  s({ day_id: DAY1, type: 'parallel', code: 'C1', title: 'Climate Risk and Business Sustainability', speaker: null, chair: 'Dr. Nguyen Le Ngan Trang', panelists: null, room: 'B1.407 (40)', start_time: '15:30', end_time: '16:30', description: null, papers: [
    p('ID 200', '15:30–15:45', 'Air Pollution and the Internal Cash Flow Allocation: Evidence from Listed Companies in Viet Nam', 'Tran Dinh Hoang, To Cong Nguyen Bao, Luong Bao Thanh Khoa, Nguyen Minh Tri'),
  ...
  s({ day_id: DAY1, type: 'parallel', code: 'C2', title: 'Innovation Ecosystems and Entrepreneurship', speaker: null, chair: 'Dr. Christopher Han', panelists: null, room: 'B1.408 (40)', start_time: '15:30', end_time: '16:30', description: null, papers: [
    ...
    p('ID 43', '15:45–16:00', 'Is Buy Now Pay Later via E-Wallet Becoming the Next Payment Trend? Exploring Factors Affecting Customer Intention in Ho Chi Minh City', 'Hoang Cuu Long, Pham Vo Hong Dung, Dang Thi Tuyet Ngan, Nguyen Viet Anh, Bui Ngoc Boi, Nguyen Manh Gia Bao, Ha Quang Bien'),
  ...
  s({ day_id: DAY1, type: 'showcase', code: null, title: 'Living Symbiosis: Guided Tour — Session 3', speaker: null, chair: null, panelists: null, room: 'B2.110', start_time: '17:30', end_time: '17:50', description: 'Guided exhibition tour. Registration is first-come, first-served (limited to 20 participants per session).', papers: null }),
  s({ day_id: DAY1, type: 'break', code: null, title: 'Welcome Dinner', speaker: null, chair: null, panelists: null, room: 'Hall B1.12A', start_time: '18:00', end_time: '21:00', description: null, papers: null }),
];
