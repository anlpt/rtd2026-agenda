...
export const day2Sessions: Session[] = [
  s({ day_id: DAY2, type: 'break', code: null, title: 'Registration & Guest Welcoming', speaker: null, chair: null, panelists: null, room: 'Lobby B1', start_time: '07:30', end_time: '08:00', description: null, papers: null }),
  ...
  s({ day_id: DAY2, type: 'break', code: null, title: 'Short Break', speaker: null, chair: null, panelists: null, room: null, start_time: '09:30', end_time: '09:45', description: null, papers: null }),
  ...
  s({ day_id: DAY2, type: 'special', code: null, title: 'FutureScape Artificial Intelligence: AI & Intelligent Systems in Business', speaker: null, chair: 'Dr. Nguyen Van Du — School of Business Information Technology, CTD-UEH', panelists: 'Dr. Nguyen Giao Hoa; Dr. Vi Chi Thanh; Dr. Nguyen Sieu Dang; Dr. Nguyen Thanh Huy', room: 'B1.205', start_time: '09:45', end_time: '11:15', description: null, papers: null }),
  ...
  s({ day_id: DAY2, type: 'break', code: null, title: 'Lunch', speaker: null, chair: null, panelists: null, room: 'Hall B1.12A', start_time: '11:15', end_time: '12:15', description: null, papers: null }),
  ...
  s({ day_id: DAY2, type: 'parallel', code: 'E3', title: 'Smart and Sustainable City I', speaker: null, chair: 'Prof. Pawinee Imtrakul', panelists: null, room: 'B1.409 (50)', start_time: '13:00', end_time: '14:00', description: null, papers: [
  ...
  s({ day_id: DAY2, type: 'break', code: null, title: 'Transportation to Vinh Long', speaker: null, chair: null, panelists: null, room: null, start_time: '14:30', end_time: '17:30', description: 'The conference continues at UEH Mekong Campus (July 17–18) and UEH Nexus Nha Trang (July 19–20).', papers: null }),
  s({ day_id: DAY2, type: 'break', code: null, title: 'Dinner', speaker: null, chair: null, panelists: null, room: null, start_time: '18:00', end_time: '20:00', description: null, papers: null }),
];
